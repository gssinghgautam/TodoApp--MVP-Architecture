...
public class AddEditTaskFragment extends Fragment implements AddedEditTaskContract.View {

    public static final String ARGUMENT_EDIT_TASK_ID = "ARGUMENT_EDIT_TASK_ID";
    private AddedEditTaskContract.Presenter mPresenter;
    ...
    @Override
    public void setPresenter(@NonNull AddedEditTaskContract.Presenter presenter) {
